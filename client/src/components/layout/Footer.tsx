...
export default function Footer() {
  return (
    <footer className="bg-primary-100 text-primary-800 py-12 border-t border-primary-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-primary-600 hover:text-gold-500 transition-colors duration-200">
        ...
        <div className="border-t border-primary-200 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-primary-600 text-sm">
              © 2024 {COMPANY_INFO.name}. All rights reserved.
            </p>
            <div className="flex space-x-6 text-sm text-primary-600">
              <a href="#" className="hover:text-gold-500 transition-colors duration-200">
                Privacy Policy
              </a>
              <a href="#" className="hover:text-gold-500 transition-colors duration-200">
                Terms of Service
